...
QFile fSize("C:/QtRepos/TravellerSalesMan/MatrixSize.txt");
QFile fMatrix("C:/QtRepos/TravellerSalesMan/Matrix.txt");
...
void QtWindow::CreateGraph()
{
    ...
    process.startDetached("C:/QtRepos/TravellerSalesMan/run.bat");
}
